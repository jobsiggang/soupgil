export const trailCourse = {
  ...
  description:
    '시작점부터 종점까지 주요 표지판과 갈림길을 비콘으로 인증하며 완주 기록을 남기는 트레일 도장깨기 앱입니다.',
  totalPoiCount: 1326,
  distanceKm: 278,
  sectionsCompleted: 1,
  sectionsTotal: 12,
  checkpoints: [
    ...
    },
    {
      ...
      altitude: 18,
      section: '도심 진입 구간',
      beaconId: 'ESP32-START-001',
      directionHints: ['직진: 구간 1 진입'],
      note: '첫 인증 지점입니다. 비콘 감지 후 출발 기록을 남깁니다.',
      stampedAt: null,
      status: 'ready',
    },
    {
